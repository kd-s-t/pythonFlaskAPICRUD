...
class Database:
	...
	def createDatabase(self):
		...
		cursor.execute("CREATE DATABASE IF NOT EXISTS "+str(self.__database_name))

		return "Database "+str(self.__database_name)+" has been created"
	...
	def createTable(self):
		...
		return "Table "+str(self.__table_name)+" has been created"
